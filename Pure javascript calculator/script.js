...
function click() {
  if (clickedButton === "clear")
    ...
    if (document.getElementById("inputField").innerHTML === "Error") clear();
    document.getElementById("inputField").innerHTML += document.getElementById(
      clickedButton
    ).innerHTML;
    equationDone = false;
    ...
    if (answer == "Infinity")
      ...
      //if it's an int don't round to two
      document.getElementById("inputField").innerHTML = answer;
    else document.getElementById("inputField").innerHTML = answer.toFixed(2);
